...
- `initiatives/simmer-paper-trading/architecture.md`
- `initiatives/simmer-paper-trading/config/strategy-profiles.yaml`
- `initiatives/simmer-paper-trading/config/tracking-schema.yaml`
- `initiatives/simmer-paper-trading/contracts/agent.md`
- `initiatives/simmer-paper-trading/contracts/skills/*.md`
- `initiatives/simmer-paper-trading/contracts/workflows/*.md`
- `initiatives/simmer-paper-trading/templates/*.yaml`
