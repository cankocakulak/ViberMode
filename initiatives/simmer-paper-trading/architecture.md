...
```text
initiatives/simmer-paper-trading/
  README.md
  architecture.md
  config/
...
- `/Users/mcan/ViberMode/initiatives/simmer-paper-trading/contracts/agent.md`: define the portable agent identity
- `/Users/mcan/ViberMode/initiatives/simmer-paper-trading/contracts/skills/`: define Simmer-facing skill contracts
- `/Users/mcan/ViberMode/initiatives/simmer-paper-trading/contracts/workflows/`: define recurring workflows
- `/Users/mcan/ViberMode/initiatives/simmer-paper-trading/config/strategy-profiles.yaml`: define strategy variants
- `/Users/mcan/ViberMode/initiatives/simmer-paper-trading/config/tracking-schema.yaml`: define attribution schema
- `/Users/mcan/ViberMode/initiatives/simmer-paper-trading/templates/`: define runtime artifact templates
